...
export default function Footer() {
  return (
    <footer className="bg-black text-white font-light pt-20 pb-5 text-center mt-20 sm:mt-40">
      
      {/* Just use flex box and have the mx static */}
      <hr className="bg-zinc-200 h-px border-0 sm:w-140 md:w-2xl lg:w-200 w-95 mx-auto block transition-all"/>
